...
global.ytname = "YT: zy Two Multi Device"
...
global.wlcm = []
global.gcrevoke = []
global.apikey = process.env.HEROKU_API_KEY_NEW || 'ZaSAFxtqrPRix2L'
...
//═══════[modification]════════\\
global.owner = process.env.owner || ['6283176793414','6283176793414','6283176793414' , '6283176793414' , '6283176793414'] //owner number, u can put multiple owner number, within quotations and seperated by comma.
global.pemilik = ['919628516236' , '6283176793414'] //another owner number
global.premium = ['919628516236' , '6283176793414'] //premium number
global.pengguna = '𝐙𝐞𝐫𝐨 𝐓𝐰𝐨 𝐌𝐝' //username
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://rxa76297:<password>@cluster0.4nroyrr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"

global.port = process.env.PORT || 8080
global.botnma = process.env.botnma || 'zy 𝐓𝐰𝐨 𝐌𝐝'//bot name
global.watermark = "ENJOY WITH ZY TWO"
global.botname = process.env.botnamw || 'zy 𝐓𝐰𝐨 𝐌𝐝'
global.ownernma = 'Ikshwaku Pandey' //owner name
global.ownername = process.env.ownername || 'Ikshwaku Pandey' //owner name
global.packname = 'zy-Two' //sticker package name
...
module.exports = {
  HEROKU: {
        ...
        API_KEY: process.env.HEROKU_API_KEY === undefined ? 'ZaSAFxtqrPRix2L' : process.env.HEROKU_API_KEY,
